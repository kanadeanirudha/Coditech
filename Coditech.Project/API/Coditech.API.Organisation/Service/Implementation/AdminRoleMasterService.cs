...
{
    public class AdminRoleMasterService : IAdminRoleMasterService
    {
        ...
        public virtual AdminRoleMasterListModel GetAdminRoleMasterList(FilterCollection filters, NameValueCollection sorts, NameValueCollection expands, int pagingStart, int pagingLength)
        {
            ...
            CoditechViewRepository<AdminRoleMasterModel> objStoredProc = new CoditechViewRepository<AdminRoleMasterModel>(_serviceProvider.GetService<Coditech_Entities>());
            objStoredProc.SetParameter("@WhereClause", pageListModel?.SPWhereClause, ParameterDirection.Input, DbType.String);
            objStoredProc.SetParameter("@PageNo", pageListModel.PagingStart, ParameterDirection.Input, DbType.Int32);
            objStoredProc.SetParameter("@Rows", pageListModel.PagingLength, ParameterDirection.Input, DbType.Int32);
            objStoredProc.SetParameter("@Order_BY", pageListModel.OrderBy, ParameterDirection.Input, DbType.String);
            objStoredProc.SetParameter("@RowsCount", pageListModel.TotalRowCount, ParameterDirection.Output, DbType.Int32);
            List<AdminRoleMasterModel> adminRoleMasterList = objStoredProc.ExecuteStoredProcedureList("RARIndia_GetAdminRoleList @WhereClause,@Rows,@PageNo,@Order_BY,@RowsCount OUT", 4, out pageListModel.TotalRowCount)?.ToList();
        ...
        public AdminRoleMasterModel CreateAdminRoleMaster(AdminRoleMasterModel adminRoleMasterModel)
        {
            ...
            if (IsAdminRoleCodeAlreadyExist(adminRoleMasterModel))
        ...
        public AdminRoleMasterModel UpdateAdminRoleMaster(AdminRoleMasterModel adminRoleMasterModel)
        {
            ...
            adminRoleMasterData.OthCentreLevel = adminRoleMasterModel.MonitoringLevel == CoditechConstant.Self ? string.Empty : "Selected";
            ...
            if (adminRoleMasterModel.MonitoringLevel == CoditechConstant.Self || (adminRoleMasterModel.MonitoringLevel == CoditechConstant.Other && adminRoleMasterModel?.SelectedRoleWiseCentres?.Count == 0))
            {
