...
namespace Coditech.API.Service
{
    public class GeneralNationalityMasterService : IGeneralNationalityMasterService
    {
        ...
        public virtual GeneralNationalityListModel GetNationalityList(FilterCollection filters, NameValueCollection sorts, NameValueCollection expands, int pagingStart, int pagingLength)
        {
            ...
            List<GeneralNationalityModel> nationalityList = objStoredProc.ExecuteStoredProcedureList("Coditech_GetNationalityList @WhereClause,@Rows,@PageNo,@Order_BY,@RowsCount OUT", 4, out pageListModel.TotalRowCount)?.ToList();
        ...
        public virtual bool DeleteNationality(ParameterModel parameterModel)
        {
            ...
            int status = 0;
            objStoredProc.ExecuteStoredProcedureList("Coditech_DeleteNationality @NationalityId,  @Status OUT", 1, out status);
