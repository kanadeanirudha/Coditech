...
namespace Coditech.API.Service
{
    public interface IAccountReportService
    {
        ...
        AccountProfitAndLossReportListModel GetProfitAndLossReportList(string selectedCentreCode, string selectedParameter1, string selectedParameter2, FilterCollection filters, NameValueCollection sorts, NameValueCollection expands, int pagingStart, int pagingLength);
    }
}
