...
namespace Coditech.API.Service
{
    public class GeneralBatchMasterService : BaseService, IGeneralBatchMasterService
    {
        ...
        public virtual GeneralBatchListModel GetBatchList(string selectedCentreCode, long entityId, FilterCollection filters, NameValueCollection sorts, NameValueCollection expands, int pagingStart, int pagingLength)
        {
            ...
            List<GeneralBatchModel> generalBatchList = objStoredProc.ExecuteStoredProcedureList("Coditech_GetGeneralBatchList @CentreCode,@EntityId @WhereClause,@Rows,@PageNo,@Order_BY,@RowsCount OUT", 6, out pageListModel.TotalRowCount)?.ToList();
