...
namespace Coditech.API.Controllers
{
    public class OrganisationCentrewiseDepartmentController : BaseController
    {
        ...
        [Route("/OrganisationCentrewiseDepartment/AssociateUnAssociateCentrewiseDepartment")]
        [HttpPut, ValidateModel]
        [Produces(typeof(OrganisationCentrewiseDepartmentResponse))]
        public virtual IActionResult AssociateUnAssociateCentrewiseDepartment([FromBody] OrganisationCentrewiseDepartmentModel model)
        {
            try
            {
                bool isUpdated = _organisationCentrewiseDepartmentService.AssociateUnAssociateCentrewiseDepartment(model);
