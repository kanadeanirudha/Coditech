...
namespace Coditech.API.Controllers
{
    public class GeneralPersonAttendanceDetailsController : BaseController
    {
        ...
        public virtual IActionResult GetPersonAttendanceList(long entityId, string userType, FilterCollection filter, ExpandCollection expand, SortCollection sort, int pageIndex, int pageSize)
        {
            try
            {
                GeneralPersonAttendanceDetailsListModel list = _generalPersonAttendanceDetailsService.GetPersonAttendanceList(entityId, userType, filter, sort.ToNameValueCollectionSort(), expand.ToNameValueCollectionExpands(), pageIndex, pageSize);
