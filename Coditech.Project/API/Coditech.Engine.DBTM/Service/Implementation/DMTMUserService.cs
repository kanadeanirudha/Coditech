...
namespace Coditech.API.Service
{
    public class DBTMUserService : BaseService, IDBTMUserService
    {
        ...
        public virtual DBTMUserModel Login(UserLoginModel userLoginModel)
        {
            ...
            UserMaster userMasterData = _userMasterRepository.Table.FirstOrDefault(x => x.UserName == userLoginModel.UserName && x.Password == userLoginModel.Password && x.UserType == UserTypeEnum.DBTMTrainee.ToString());
        ...
        public virtual DBTMUserModel UpdateAdditionalInformation(DBTMUserModel dbtmUserModel)
        {
            ...
            {
                UserMaster userMasterData = _userMasterRepository.Table.Where(x => x.EntityId == dbtmUserModel.EntityId && x.UserType == UserTypeEnum.DBTMTrainee.ToString())?.FirstOrDefault();
