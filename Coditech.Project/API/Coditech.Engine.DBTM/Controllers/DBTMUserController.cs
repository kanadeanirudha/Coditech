...
namespace Coditech.API.Controllers
{
    ...
    public class DBTMUserController : BaseController
    {
        ...
        public virtual IActionResult UpdateAdditionalInformation([FromBody] DBTMUserModel dbtmUserModel)
        {
            ...
            {
                _coditechLogging.LogMessage(ex, CoditechLoggingEnum.Components.DBTMUser.ToString(), TraceLevel.Warning);
            ...
            {
                _coditechLogging.LogMessage(ex, CoditechLoggingEnum.Components.DBTMUser.ToString(), TraceLevel.Error);
