...
namespace Coditech.Engine.DBTM.Controllers
{
    public class DBTMDeviceDataController : BaseController
    {
        ...
        public virtual IActionResult InsertDeviceData([FromBody] DBTMDeviceDataModel model)
        {
            ...
            {
                _coditechLogging.LogMessage(ex, CoditechLoggingEnum.Components.DBTMDeviceData.ToString(), TraceLevel.Warning);
            ...
            {
                _coditechLogging.LogMessage(ex, CoditechLoggingEnum.Components.DBTMDeviceData.ToString(), TraceLevel.Error);
