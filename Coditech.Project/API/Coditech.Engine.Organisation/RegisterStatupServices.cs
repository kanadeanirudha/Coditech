...
namespace Coditech.API.Common
{
    ...
    public static class RegisterStatupServices
    {
        ...
        public static void RegisterDI(this WebApplicationBuilder builder)
        {
            ...
            builder.Services.AddScoped<IGeneralEnumaratorMasterService, GeneralEnumaratorMasterService>();
            builder.Services.AddScoped<IGeneralEnumaratorGroupMasterService, GeneralEnumaratorGroupMasterService>();
