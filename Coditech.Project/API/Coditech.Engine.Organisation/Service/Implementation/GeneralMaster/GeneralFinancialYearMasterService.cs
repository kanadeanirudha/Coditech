...
namespace Coditech.API.Service
{
    public class GeneralFinancialYearMasterService : IGeneralFinancialYearMasterService
    {
        ...
        private readonly ICoditechRepository<GeneralFinancialYearMaster> _generalFinancialYearMasterRepository;
        public GeneralFinancialYearMasterService(ICoditechLogging coditechLogging, IServiceProvider serviceProvider)
        {
            _serviceProvider = serviceProvider;
            _coditechLogging = coditechLogging;
            _generalFinancialYearMasterRepository = new CoditechRepository<GeneralFinancialYearMaster>(_serviceProvider.GetService<Coditech_Entities>());
        }
        ...
        public virtual GeneralFinancialYearModel CreateFinancialYear(GeneralFinancialYearModel generalFinancialYearModel)
        {
            ...
            GeneralFinancialYearMaster generalFinancialYearMaster = generalFinancialYearModel.FromModelToEntity<GeneralFinancialYearMaster>();

            //Create new FinancialYear and return it.
            GeneralFinancialYearMaster FinancialYearData = _generalFinancialYearMasterRepository.Insert(generalFinancialYearMaster);
            if (FinancialYearData?.GeneralFinancialYearMasterId > 0)
            {
                generalFinancialYearModel.GeneralFinancialYearMasterId = FinancialYearData.GeneralFinancialYearMasterId;
            }
            else
            {
        ...
        public virtual GeneralFinancialYearModel GetFinancialYear(short FinancialYearId)
        {
            ...
            GeneralFinancialYearMaster generalFinancialYearMaster = _generalFinancialYearMasterRepository.Table.FirstOrDefault(x => x.GeneralFinancialYearMasterId == FinancialYearId);
        ...
        public virtual bool UpdateFinancialYear(GeneralFinancialYearModel generalFinancialYearModel)
        {
            ...
            if (generalFinancialYearModel.GeneralFinancialYearMasterId < 1)
                throw new CoditechException(ErrorCodes.IdLessThanOne, string.Format(GeneralResources.ErrorIdLessThanOne, "FinancialYearID"));

            //if (IsFinancialYearCodeAlreadyExist(generalFinancialYearModel.FinancialYearCode, generalFinancialYearModel.GeneralFinancialYearMasterId))
            //    throw new CoditechException(ErrorCodes.AlreadyExist, string.Format(GeneralResources.ErrorCodeExists, "FinancialYear Code"));
