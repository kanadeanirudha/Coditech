...
namespace Coditech.API.Client
{
    public interface IGeneralEnumaratorGroupClient : IBaseClient
    {
        ...
        GeneralEnumaratorGroupResponse CreateGeneralEnumaratorGroup(GeneralEnumaratorGroupModel body);
        ...
        /// <returns>Returns GeneralEnumaratorGroupResponse.</returns>
        GeneralEnumaratorGroupResponse GetGeneralEnumaratorGroup(int generalEnumaratorGroupId);
        ...
        GeneralEnumaratorGroupResponse UpdateGeneralEnumaratorGroup(GeneralEnumaratorGroupModel body);
        ...
        TrueFalseResponse DeleteGeneralEnumaratorGroup(ParameterModel body);
    }
}
