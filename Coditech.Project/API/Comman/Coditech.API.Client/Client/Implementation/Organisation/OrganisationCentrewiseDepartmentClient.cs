...
namespace Coditech.API.Client
{
    public class OrganisationCentrewiseDepartmentClient : BaseClient, IOrganisationCentrewiseDepartmentClient
    {
        ...
        public virtual OrganisationCentrewiseDepartmentResponse AssociateUnAssociateCentrewiseDepartment(OrganisationCentrewiseDepartmentModel body)
        {
            return Task.Run(async () => await AssociateUnAssociateCentrewiseDepartmentAsync(body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<OrganisationCentrewiseDepartmentResponse> AssociateUnAssociateCentrewiseDepartmentAsync(OrganisationCentrewiseDepartmentModel body, System.Threading.CancellationToken cancellationToken)
        {
            string endpoint = organisationCentrewiseDepartmentEndpoint.AssociateUnAssociateCentrewiseDepartmentAsync();
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
