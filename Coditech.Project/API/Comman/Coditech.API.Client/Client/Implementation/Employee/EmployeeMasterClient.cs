...
namespace Coditech.API.Client
{
    public class EmployeeMasterClient : BaseClient, IEmployeeMasterClient
    {
        ...
        public virtual EmployeeMasterListResponse EmployeeServiceList(long employeeId, IEnumerable<string> expand, IEnumerable<FilterTuple> filter, IDictionary<string, string> sort, int? pageIndex, int? pageSize)
        {
        ...
        public virtual async Task<EmployeeMasterListResponse> EmployeeServiceListAsync(long employeeId, IEnumerable<string> expand, IEnumerable<FilterTuple> filter, IDictionary<string, string> sort, int? pageIndex, int? pageSize, CancellationToken cancellationToken)
        {
            string endpoint = employeeMasterEndpoint.EmployeeServiceListAsync(employeeId,expand, filter, sort, pageIndex, pageSize);
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
