...
namespace Coditech.API.Client
{
    public class EmployeeServiceClient : BaseClient, IEmployeeServiceClient
    {
        ...
        public virtual EmployeeServiceResponse GetEmployeeService(long employeeServiceId)
        {
            return Task.Run(async () => await GetEmployeeServiceAsync(employeeServiceId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<EmployeeServiceResponse> GetEmployeeServiceAsync(long employeeServiceId, System.Threading.CancellationToken cancellationToken)
        {
            if (employeeServiceId <= 0)
                throw new System.ArgumentNullException("employeeServiceId");

            string endpoint = employeeServiceEndpoint.GetEmployeeServiceAsync(employeeServiceId);
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
        ...
        {
            return Task.Run(async () => await UpdateServiceAsync(body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<EmployeeServiceResponse> UpdateServiceAsync(EmployeeServiceModel body, System.Threading.CancellationToken cancellationToken)
        {
        ...
        {
            return Task.Run(async () => await DeleteServiceAsync(body, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<TrueFalseResponse> DeleteServiceAsync(ParameterModel body, System.Threading.CancellationToken cancellationToken)
        {
