...
namespace Coditech.API.Client
{
    public class GeneralDepartmentClient : BaseClient, IGeneralDepartmentClient
    {
        ...
        public virtual GeneralDepartmentListResponse GetDepartmentsByCentreCode(string centreCode)
        {
            return Task.Run(async () => await GetDepartmentsByCentreCode(centreCode, CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<GeneralDepartmentListResponse> GetDepartmentsByCentreCode(string centreCode, CancellationToken cancellationToken)
        {
            string endpoint = generalDepartmentEndpoint.GetDepartmentsByCentreCode(centreCode);
            HttpResponseMessage response = null;
            var disposeResponse = true;
