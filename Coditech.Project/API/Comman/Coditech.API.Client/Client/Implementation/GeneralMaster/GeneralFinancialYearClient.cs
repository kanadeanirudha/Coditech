...
namespace Coditech.API.Client
{
    public class GeneralFinancialYearClient : BaseClient, IGeneralFinancialYearClient
    {
        ...
        public virtual GeneralFinancialYearResponse GetCurrentFinancialYear(int accSetupBalanceSheetId)
        {
            return Task.Run(async () => await GetCurrentFinancialYearAsync(accSetupBalanceSheetId, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<GeneralFinancialYearResponse> GetCurrentFinancialYearAsync(int accSetupBalanceSheetId, System.Threading.CancellationToken cancellationToken)
        {

            string endpoint = generalFinancialYearEndpoint.GetCurrentFinancialYearAsync(accSetupBalanceSheetId);
            HttpResponseMessage response = null;
            var disposeResponse = true;
            try
            {
