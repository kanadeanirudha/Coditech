...
namespace Coditech.API.Client
{
    public class DBTMTraineeAssignmentClient : BaseClient, IDBTMTraineeAssignmentClient
    {
        ...
        public virtual DBTMTraineeAssignmentListResponse List(IEnumerable<string> expand, IEnumerable<FilterTuple> filter, IDictionary<string, string> sort, int? pageIndex, int? pageSize)
        {
            return Task.Run(async () => await ListAsync(expand, filter, sort, pageIndex, pageSize, System.Threading.CancellationToken.None)).GetAwaiter().GetResult();
        }

        public virtual async Task<DBTMTraineeAssignmentListResponse> ListAsync(IEnumerable<string> expand, IEnumerable<FilterTuple> filter, IDictionary<string, string> sort, int? pageIndex, int? pageSize, CancellationToken cancellationToken)
        {
            string endpoint = dBTMTraineeAssignmentEndpoint.ListAsync(expand, filter, sort, pageIndex, pageSize);
