...
namespace Coditech.API.Endpoint
{
    public class OrganisationCentrewiseDepartmentEndpoint : BaseEndpoint
    {
        ...
        public string AssociateUnAssociateCentrewiseDepartmentAsync() =>
               $"{CoditechAdminSettings.CoditechOrganisationApiRootUri}/OrganisationCentrewiseDepartment/AssociateUnAssociateCentrewiseDepartment";
    }
}
