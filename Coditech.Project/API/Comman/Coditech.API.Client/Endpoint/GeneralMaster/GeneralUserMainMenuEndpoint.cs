...
namespace Coditech.API.Endpoint
{
    public class GeneralUserMainMenuEndpoint : BaseEndpoint
    {
        ...
        {
            string endpoint = $"{CoditechAdminSettings.CoditechOrganisationApiRootUri}/GeneralCountryMaster/GetUserMainMenuList{BuildEndpointQueryString(expand, filter, sort, pageIndex, pageSize)}";
            return endpoint;
        }
