...
namespace Coditech.API.Endpoint
{
    public class GeneralEnumaratorGroupEndpoint : BaseEndpoint
    {
        ...
        public string GetEnumaratorGroupAsync(int generalEnumaratorGroupId) =>
            $"{CoditechAdminSettings.CoditechOrganisationApiRootUri}/GeneralEnumaratorGroupMaster/GetEnumaratorGroup?generalEnumaratorGroupMasterId={generalEnumaratorGroupId}";
