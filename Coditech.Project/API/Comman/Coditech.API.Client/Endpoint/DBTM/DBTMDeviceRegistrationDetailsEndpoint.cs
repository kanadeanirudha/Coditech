...
namespace Coditech.API.Endpoint
{
    public class DBTMDeviceRegistrationDetailsEndpoint : BaseEndpoint
    {
        ...
        {
            string endpoint = $"{CoditechAdminSettings.CoditechDBTMApiRootUri}/DBTMDeviceRegistrationDetails/GetDBTMDeviceRegistrationDetailsList{BuildEndpointQueryString(expand, filter, sort, pageIndex, pageSize)}";
            return endpoint;
        }
