...
namespace Coditech.API.Endpoint
{
    public class DBTMMySubscriptionPlanEndpoint : BaseEndpoint
    {
        ...
        {
            string endpoint = $"{CoditechAdminSettings.CoditechDBTMApiRootUri}/DBTMMySubscriptionPlan/GetDBTMMySubscriptionPlanList?entityId={entityId}{BuildEndpointQueryString(true,expand, filter, sort, pageIndex, pageSize)}";
            return endpoint;
        }
    }
}
