...
namespace Coditech.API.Endpoint
{
    public class DBTMTraineeDetailsEndpoint : BaseEndpoint
    {
        ...
        {
            string endpoint = $"{CoditechAdminSettings.CoditechDBTMApiRootUri}/DBTMTraineeDetails/GetTraineeActivitiesDetailsList?dBTMDeviceDataId={dBTMDeviceDataId}{BuildEndpointQueryString(true,expand, filter, sort, pageIndex, pageSize)}";
            return endpoint;
        }
    }
}
