...
namespace Coditech.API.Endpoint
{
    public class DBTMSubscriptionPlanEndpoint : BaseEndpoint
    {
        ...
        {
            string endpoint = $"{CoditechAdminSettings.CoditechDBTMApiRootUri}/DBTMSubscriptionPlan/GetDBTMSubscriptionPlanList{BuildEndpointQueryString(true,expand, filter, sort, pageIndex, pageSize)}";
            return endpoint;
        }
