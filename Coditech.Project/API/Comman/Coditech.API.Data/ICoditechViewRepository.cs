...
{
    public interface ICoditechViewRepository<T>
    {
        /// <summary>
        ...
        void SetTableValueParameter(string ParameterName, DataTable ParameterValue, ParameterDirection Direction, SqlDbType dbType, string tableValueTypeName);
