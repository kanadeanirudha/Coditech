...
namespace Coditech.API.Service
{
	public class GymMembershipPlanService : BaseService, IGymMembershipPlanService
	{
		...
		public virtual bool UpdateGymMembershipPlan(GymMembershipPlanModel gymMembershipPlanModel)
		{
			...
			{
				GymMembershipPlanPackage gymMembershipPlanPackage = new GymMembershipPlanPackage()
				{
					GymMembershipPlanId = gymMembershipPlan.GymMembershipPlanId
				};
				_gymMembershipPlanPackageRepository.Delete(gymMembershipPlanPackage);
				SaveGymMembershipPlanPackage(gymMembershipPlanModel);
			}
			return isUpdated;
		}
		...
		protected void SaveGymMembershipPlanPackage(GymMembershipPlanModel gymMembershipPlanModel)
		{
