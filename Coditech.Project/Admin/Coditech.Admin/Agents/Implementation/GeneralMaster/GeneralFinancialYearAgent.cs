    ...
    public class GeneralFinancialYearAgent : BaseAgent, IGeneralFinancialYearAgent
    {
        ...
        public virtual GeneralFinancialYearListViewModel GetFinancialYearList(DataTableViewModel dataTableModel)
        {
            ...
            if (!string.IsNullOrEmpty(dataTableModel.SearchBy))
            {
                ...
                filters.Add("FinancialYearName", ProcedureFilterOperators.Like, dataTableModel.SearchBy);
                filters.Add("FinancialYearCode", ProcedureFilterOperators.Like, dataTableModel.SearchBy);
            }

            SortCollection sortlist = SortingData(dataTableModel.SortByColumn = string.IsNullOrEmpty(dataTableModel.SortByColumn) ? "FinancialYearName" : dataTableModel.SortByColumn, dataTableModel.SortBy);
        ...
        protected virtual List<DatatableColumns> BindColumns()
        {
            ...
            {
                ColumnName = "FinancialYear Name",
                ColumnCode = "FinancialYearName",
                IsSortable = true,
            });
            datatableColumnList.Add(new DatatableColumns()
            {
                ColumnName = "FinancialYear Code",
                ColumnCode = "FinancialYearCode",
                IsSortable = true,
            });
            datatableColumnList.Add(new DatatableColumns()
            {
