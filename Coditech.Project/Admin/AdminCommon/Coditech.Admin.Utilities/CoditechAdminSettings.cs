...
namespace Coditech.Admin.Utilities
{
    public static class CoditechAdminSettings
    {
        ...
        public static string CoditechApiRootUri
        {
            get
            {
                return Convert.ToString(settings["ApiDomainKey"]);
            }
        }

        public static string EnableSQLSession
        {
            get
            {
                return Convert.ToString(settings["EnableSQLSession"]);
            }
        }
        ...
        /// <summary>
        /// Gets the maximum buffer size for generic parser import.
        /// </summary>
        /// <returns>The maximum buffer size for generic parser import.</returns>
        ...
        /// <summary>
        /// Gets the location of the file upload for imports.
        /// </summary>
        /// <returns>
        /// The location of the file upload for imports.
        /// </returns>
